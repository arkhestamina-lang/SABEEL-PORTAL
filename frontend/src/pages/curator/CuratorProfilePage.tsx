...
export default function CuratorProfilePage() {
  ...
  return (
    <div className="px-4 pt-8 pb-4 flex flex-col gap-4">
      ...
      <button onClick={() => { logout(); navigate('/login'); }} className="w-full bg-card border border-black/10 text-dark/60 font-heading uppercase tracking-wider py-3.5 rounded-xl text-sm">
        Выйти
      </button>
